...
if __name__ == "__main__":
    ...
    ce_train, ce_test, acc_train, acc_test, w = t.trainModel(mx_train, my_train, mx_test, my_test, learn_rate=0.02, rand=4, my_iter=120, display_step=20)
